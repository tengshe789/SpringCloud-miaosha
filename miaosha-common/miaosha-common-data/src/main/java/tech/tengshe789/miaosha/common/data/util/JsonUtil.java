package tech.tengshe789.miaosha.common.data.util;
...
import tech.tengshe789.miaosha.common.core.util.Exceptions;
import tech.tengshe789.miaosha.common.data.jackon.Java8TimeModule;
import tech.tengshe789.miaosha.common.data.jackon.MiaoshaBeanSerializerModifier;
...
public class JsonUtil {
	...
	public static class JacksonObjectMapper extends ObjectMapper {
		...
		public JacksonObjectMapper() {
			...
			//序列化处理
			super.setSerializerFactory(this.getSerializerFactory().withSerializerModifier(new MiaoshaBeanSerializerModifier()));
			super.getSerializerProvider().setNullValueSerializer(MiaoshaBeanSerializerModifier.NullJsonSerializers.STRING_JSON_SERIALIZER);
			//日期格式化
			super.registerModule(new Java8TimeModule());
			super.findAndRegisterModules();
		}
