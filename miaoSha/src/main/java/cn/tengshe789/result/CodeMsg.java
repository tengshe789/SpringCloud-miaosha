...
public class CodeMsg {
    ...
    //邮件模块 5006XX
    public static final CodeMsg MAIL_ERROR = new CodeMsg(500600, "邮件发送失败");
    public static final CodeMsg MAIL_FORMAT_ERROR = new CodeMsg(500600, "邮件格式错误");
    public static final CodeMsg MAIL_CONTENET_ISNULL = new CodeMsg(500600, "邮件正文不能为空");
